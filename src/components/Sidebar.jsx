  ...
  return(
    <>
      ...
      <div className="absolute md:hidden block top-6 right-3">
        {mobileMenuOpen ? (
          <RiCloseLine className="w-6 h-6 tet-white mr-2"onClick={() => setMobileMenuOpen(false)}/>
        ): (<HiOutlineMenu className="w-6 h-6 tet-white mr-2" onClick={() => setMobileMenuOpen(true)}/>)
        }
      </div>
